...
public class VibratorSettings extends PreferenceFragment implements
    ...
    private static final String VIB_NODE = "/sys/class/leds/vibrator/vtg_level";
    ...
    private static final int defaultValue = 2000;
    private static final int minValue = 1504;
    private static final int maxValue = 3544;
